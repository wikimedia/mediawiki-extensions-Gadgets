...
$messages['el'] = array(
	...
	'gadgets-prefstext' => 'Παρακάτω υπάρχει μια λίστα από ειδικές συσκευές που μπορείς να ενεργοποιήσεις από τον λογαριασμό σου. Αυτές οι συσκευές είναι βασισμένες κυρίως στη γλώσσα JavaScript, οπότε θα πρέπει να έχετε ενεργοποιημένη την JavaScript στον πλοηγητή σας για να δουλέψουν. Αυτές οι συσκευές βέβαια δεν έχουν κάποιο αποτέλεσμα στη σελίδα προτιμήσεών σας.

Επίσης αυτές οι συσκευές δεν είναι μέρος του λογισμικού MediaWiki, και συνήθως αναπτύσσονται και συντηρούνται από χρήστες στο τοπικό σας βίκι. Οι διαχειριστές εκεί μπορούν να επεξεργαστούν τις διαθέσιμες συσκευές χρησιμοποιώντας το [[MediaWiki:Gadgets-definition]] και το [[Special:Gadgets]].',
	'gadgets'           => 'Συσκευές',
...
Также учтите, что эти гаджеты не являются частью MediaWiki, и обычно рарабатываются и обслуживаются участниками вики.
 ...
 */
$messages['uk'] = array(
	'gadgets-desc'      => 'дозволяє користувачам вибирати [[Special:Достосування|CSS- та JavaScript-достосування]] у своїх [[Special:Preferences|налаштуваннях]]',
	'gadgets-prefs'     => 'Достосування',
	'gadgets-prefstext' => 'Нижче наведений список спеціальних достосувань, які ви можете ввімкнути для свого облікового запису.
Ці достосування переважно базуються на JavaScript, тому ви повинні ввімкнути JavaScript для того, щоб вони працювали.
Зауважте, що ці достосування не працюють на сторінці налаштувань.

Також зауважте, що ці достосування не є частиною MediaWiki і зазвичай розробляються і обслуговуються користувачами  вікі.
Адміністратори можуть змінювати список достосувань за допомогою сторінок [[MediaWiki:Gadgets-definition]] та [[Special:Gadgets]].',
	'gadgets'           => 'Достосування',
	'gadgets-title'     => 'Достосування',
	'gadgets-pagetext'  => 'Нижче наведений список достосувань, які можна ввімкнути на сторінці [[Special:Preferences|налаштувань]].
Цей список дозволяє легко переглядати повідомлення, які містять описи достосувань.',
