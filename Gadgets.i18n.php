...
$messages['sr-ec'] = array(
	...
	'gadgets-prefstext' => 'Испод је списак посебних справица које можете да омогућите на свом налогу.
...
Ове посебне справице нису део софтвера Медијавики, већ се развијају и одржавају од стране корисника на вашој викији.
Администратори могу да измене [[MediaWiki:Gadgets-definition|значења]] и [[Special:Gadgets|описе]] доступних справица.',
	'gadgets' => 'Гаџети',
