...
class ApiGetGadgetPrefs extends ApiBase {
	...
	public function getDescription() {
		return 'Allows user code to get preferences for gadgets, along with preference descriptions and values for the currently logged-in user';
	}
	...
	public function getVersion() {
		return __CLASS__ . ': $Id: ApiGetGadgetPrefs.php 95100 2011-08-20 17:49:07Z salvatoreingala $';
	}
}
