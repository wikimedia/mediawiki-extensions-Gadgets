...
/**
 * German iternationalisation file for the ContactPage extension
 *
 * @package MediaWiki
...
$messages['gadgetprefstext']= 'Liste von speziellen Gadgets die für jeden Benutzer aktiviert werden können.
...
verfügbaren Gadgets auf der Seite [[MediaWiki:Gadgets]] bearbeiten';

#for Special:Gadgets
$messages['gadgets'] = 'Gadgets';
$messages['gadgets-title'] = 'Gadgets';
$messages['gadgets-pagetext'] = 'Liste von speziellen Gadgets, die für jeden Benutzer verfügbar sind, wie in [[MediaWiki:Gadgets]] definiert.
Diese Übersicht bietet direkten Zugang zu den Systemnachrichten, die die Beschreibung sowie den Programmcode jedes
Gadgets enthalten.';
$messages['gadgets-uses'] = 'Benutzt';
?>
